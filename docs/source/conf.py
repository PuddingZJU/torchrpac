...
# -*- coding: utf-8 -*-
#
# Torchpac documentation build configuration file, created by
...
version = torchpac.__version__
# The full version, including alpha/beta/rc tags.
release = torchpac.__version__
...
latex_documents = [
    (master_doc, 'Torchpac.tex', 'Torchpac Documentation',
...
man_pages = [
    (master_doc, 'torchpac', 'Torchpac Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Torchpac', 'Torchpac Documentation',
     author, 'Torchpac', 'One line description of project.',
     'Miscellaneous'),
]
